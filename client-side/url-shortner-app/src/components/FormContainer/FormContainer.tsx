      ...
      <div className="container mx-auto p-2">
        <div className="bg-banner my-8 rounded-xl bg-cover bg-center">
            <div className='w-full h-full rounded-xl p-20 backdrop-brightness-50'>
                ...
                <p className="text-white text-center pb-2 text-xl font-extralight">Paste your link to be shortened</p>
                <p className='text-white text-center pb-4 text-sm font-thin'>Free tool to shorten a URL or reduce a link, Use our URL shorterner to generate a neat link</p>
